...
def get_data():
    Played_albums ='https://rss.applemarketingtools.com/api/v2/ao/music/most-played/50/albums.json'
    playedalbums = pd.read_json(Played_albums)
...
def get_data():
    Played_albums ='https://rss.applemarketingtools.com/api/v2/ag/music/most-played/50/albums.json'
    playedalbums = pd.read_json(Played_albums)
...
print("-----Apple Music Charts Antigua and Barbuda (Top 100)-----")
print("**Top albums actively played " + str(playedalbums))


def get_data():
    Played_albums ='https://rss.applemarketingtools.com/api/v2/ar/music/most-played/50/albums.json'
    playedalbums = pd.read_json(Played_albums)
...
print("-----Apple Music Charts Argentina (Top 100)-----")
print("**Top albums actively played " + str(playedalbums))
